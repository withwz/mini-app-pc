...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ra(){return new bn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Fs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ca(){return new bn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fs(),fragmentShader:`
...
`].filter(wi).join(`
`)),a=gs(a),a=Ha(a,t),a=Ga(a,t),o=gs(o),o=Ha(o,t),o=Ga(o,t),a=ka(a),o=ka(o),t.isRawShaderMaterial!==!0&&(A=`#version 300 es
